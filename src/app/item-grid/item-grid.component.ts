...
export class ItemGridComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: ActivatedRoute, private itemGridService: ItemGridService, private utility: UtilityService, private route: Router) { }
